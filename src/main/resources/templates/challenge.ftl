...
<html lang="en">
	...
	<body id="top">
		...
		<div id="content" class="container">
			<div class="row">
				<div class="text-center">We will spice this up at some point</div>
				<br/>
				<div class="col-lg-8 col-lg-offset-2 well well-lg">
					...
					<br/><br/>
					<#if auth>
						Simply click the "account" button at the top of your screen and then click the "begin challenge" button to get started!
					<#else/>
