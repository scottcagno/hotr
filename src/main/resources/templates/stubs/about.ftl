<div id="about" class="container">
	...
	<div class="row">
		...
		<div class="col-lg-8 col-sm-6">
			...
			<p class="lead">
				...
				onto the flames making them burn brighter.
			</p>
		</div>
	</div>
	<hr class="divider">
	...
	<div class="row">
		...
		<div class="col-lg-4 col-sm-6">
			<img src="/static/img/home/bedcouple.png" class="img-responsive">
		</div>
	</div>
	<hr class="divider">
	<div class="row">
		...
		<div class="col-lg-9 col-sm-6">
			...
			<p class="lead">
				...
				over 100 Biblically-based family life workshops a year and have ministered to over 70,000
				families.
			</p>
		</div>
